...
let
  ...
  workspaces = with host;
    if hostName == "desktop" then ''
      monitor=${toString mainMonitor},1920x1080@144,1080x420,1
      monitor=${toString secondMonitor},1080x1920@75,0x0,1
    '' else if hostName == "laptop" then ''
      monitor=${toString mainMonitor},1920x1080@60,0x0,1
    '' else ''
      monitor=${toString mainMonitor},1600x900@60,0x0,1
    '';
  monitors = with host;
    if hostName == "desktop" then ''
      ...
      wsbind=1,${toString secondMonitor}
      wsbind=2,${toString mainMonitor}
      wsbind=3,${toString mainMonitor}
      wsbind=4,${toString mainMonitor}
      wsbind=5,${toString mainMonitor}
      wsbind=6,${toString mainMonitor}
      wsbind=7,${toString mainMonitor}
      wsbind=8,${toString mainMonitor}
      wsbind=9,${toString mainMonitor}
      wsbind=0,${toString mainMonitor}
    '' else "";
  execute = with host;
...
in {
  ...
  services.swayidle = with host; if hostName == "desktop" || hostName == "laptop" then {
    enable = true;
    events = [
